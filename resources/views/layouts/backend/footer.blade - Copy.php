...
<!-- <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2024 <a href="https://justairports.com//">justairports.com</a>.</strong> All rights
    reserved.
</footer> -->
</div>
<!-- Modal -->
                ...
                <section class="new_job_section">
                    ...
                    <div class="new_job_container container">
                        <form action="{{ route('admin.new_job.store') }}" method="POST" id="form_data"
                            ...
                            <!-- <div class="row">
                  <div class="accordion mb-1 mt-2">
                    <div id="accordion-list"><a href="#">Panel <i class="fa fa-angle-down" aria-hidden="true"></i></a></div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 d-flex"> 
                                                ...
                                                <input type="text" style="width: 100%;" name="pickup_detail" id="pickup_detail">
                                                    <!-- <select class="select2" data-placeholder="Pickup" style="width: 100%;" name="pickup_detail" id="pickup_detail"> 
                                                                                                   </select> -->
                                                </div> 
...
<script>
    ...
    $(document).on("blur", "#drop", async function(){
           ...
           let append_html = '<option>Select</option>';
            ...
            //  &postcode=${postcode}&airport_id=${airport_id}&job_time=${job_time}&job_day=${job_day}`);
            //  let responseData = await response.json();
